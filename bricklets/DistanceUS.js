...
module.exports = function(RED) {
	function tinkerForgeDistanceUS(n) {
        ...
        function(connectReason) {
            node.t = new Tinkerforge.BrickletDistanceUS(node.sensor, node.ipcon);
    ...
    RED.nodes.registerType('TinkerForge DistanceUS', tinkerForgeDistanceUS);
};
