...
module.exports = function(RED) {
	function tinkerForgeLinearPoti(n) {
        ...
        function(connectReason) {
            node.t = new Tinkerforge.BrickletLinearPoti(node.sensor, node.ipcon);
    ...
    RED.nodes.registerType('TinkerForge LinearPoti', tinkerForgeLinearPoti);
};
